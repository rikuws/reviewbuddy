...
pub fn generate_code_tour(
    ...
    let response = run_code_tour_bridge::<_, CodeTourGenerationResponse>(&CodeTourBridgeRequest {
        action: "generate",
    ...
    R: DeserializeOwned,
{
    ...
    serde_json::from_slice::<R>(&output.stdout).map_err(|error| {
        format!(
